...
const DashboardLayout = ({ children, currentPage }: DashboardLayoutProps) => {
  ...
  const menuItems = [
    ...
    { icon: CalendarDays, label: 'Kalender', path: '/calendar', roles: ['admin', 'guru', 'siswa'] },
    { icon: ClipboardList, label: 'Permintaan', path: '/requests', roles: ['admin', 'guru', 'siswa'] },
      ...
      <header className="sticky top-0 z-50 w-full border-b bg-card shadow-sm">
        <div className="container flex h-16 items-center justify-between px-4">
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-lg font-bold">Portal Kampus</h1>
          </div>
